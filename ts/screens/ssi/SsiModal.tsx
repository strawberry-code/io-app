...
const SsiModal = forwardRef((_props, ref) => {
  useImperativeHandle(ref,
    () => ({
      setModalVisibility(shouldVisible: boolean) {
        setModalVisible(shouldVisible)
      },
      changeText(shouldVisible: boolean) {
        setModalVisible(shouldVisible)
      }
    }))
