      ...
      >
        <Text style={styles.title}>Ricevi nel Wallet</Text>
          <View style={{ padding: 30, justifyContent: 'space-around'}}>
            <Image source={require('../../../img/icons/qr_code_image.png')} style={styles.image} />
            <Text style={styles.descriptionTitle}>Descrizione</Text>
            <Text style={styles.descriptionText}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum ac ipsum porttitor, egestas erat in, blandit lorem. </Text>
          ...
          <TouchableHighlight style={button.container} onPress={() => alert('da definire')} >
            <Text style={button.text}>{I18n.t('ssi.balanceAndTransaction.receiveButton')}</Text>
          </TouchableHighlight>
        </View>
